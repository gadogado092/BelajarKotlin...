...
class DetailActivityTeam : AppCompatActivity(), PlayerView {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        team  = bundle.getParcelable<TeamModel>("selected_match") as TeamModel
        ...
        Picasso.get().load(team.strTeamBadge).into(teamBadage)
